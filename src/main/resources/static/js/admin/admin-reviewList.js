        ...
        detailContent +=
            `
                ...
                reviewBoard.reviewFileDTOS && reviewBoard.reviewFileDTOS.length > 0
                    ? reviewBoard.reviewFileDTOS.map(fileDTO => `<img src="/reviewBoardFiles/display?fileName=Review/${fileDTO.filePath}/${fileDTO.fileUUID}_${fileDTO.fileOriginalName}" />`).join('')
