...
function showList(nowKidsDTOS) {
    ...
    nowKidsDTOS.forEach(nowKids => {
        ...
        let  fullAddress = nowKids.eventAddress + ' ' + nowKids.eventAddressDetail + ' ' + nowKids.memberAddressSubDetail;
        ...
        detailContent +=
			...
			<div class="user-modal-shape">
                ...
                nowKids.nowKidsFileDTOS && nowKids.nowKidsFileDTOS.length > 0
                    ? nowKids.nowKidsFileDTOS.map(fileDTO => `<img src="/announcementFiles/display?fileName=Review/${fileDTO.filePath}/${fileDTO.fileUUID}_${fileDTO.fileOriginalName}" />`).join('')
