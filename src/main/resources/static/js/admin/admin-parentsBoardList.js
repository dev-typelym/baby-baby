        ...
        detailContent +=
			...
			<div class="user-modal-shape">
                ...
                parentsBoard.parentsBoardFileDTOS && parentsBoard.parentsBoardFileDTOS.length > 0
                    ? parentsBoard.parentsBoardFileDTOS.map(fileDTO => `<img src="/announcementFiles/display?fileName=ParentsBoard/${fileDTO.filePath}/${fileDTO.fileUUID}_${fileDTO.fileOriginalName}" />`).join('')
