                        ...
                        <div class="feed-header-inner-flex">
                            <div class="feed-header-left-flex">
                                <a class="feed-header-user-img-wrap">
                                    ...
                                    data-member-profile-path="${nowKidsDTOSAjax[i].memberProfilePath}" 
                                    data-member-profile-uuid="${nowKidsDTOSAjax[i].memberProfileUUID}"
                                    data-member-profile-original-name="${nowKidsDTOSAjax[i].memberProfileOriginalName}">
                                    >
                                ...
                                <div class="feed-header-new-board">
                                    <em class="feed-header-user-name">
                                        ${nowKidsDTOSAjax[i].memberNickname}
                                    </em>
                                </div>
                            </div>
                            <span class="feed-header-time">${getTimeAgo(nowKidsDTOSAjax[i].eventStartDate)}</span>
                        </div>
                    </section>
                    <div class=title-like-wrap>
                        <button type="button" class="wish-button" aria-pressed="${nowKidsDTOSAjax[i].isLiked}" nowKidsId="${nowKidsDTOSAjax[i].nowKidsId}" eventId="${nowKidsDTOS[i].eventId}">
                        ...
                        <span class="bottom-event-title">${nowKidsDTOSAjax[i].boardTitle}</span>
                    </div>
...
loadMoreContentFirstPage()
function loadMoreContentFirstPage() {
    nowKidsDTOS.forEach((e, i) => {
        ...
        text += `
                <div class="bottom-content-flex" id ="${i}">
                    <section class="feed-header-full-wrap">
                        ...
                        <div class="feed-header-inner-flex">
                            <div class="feed-header-left-flex">
                                <a class="feed-header-user-img-wrap">
                                    <span class="feed-header-user-img"
                                    data-member-profile-path="${nowKidsDTOS[i].memberProfilePath}"
                                    data-member-profile-uuid="${nowKidsDTOS[i].memberProfileUUID}"
                                    data-member-profile-original-name="${nowKidsDTOS[i].memberProfileOriginalName}">
                                    >
                                    <span class="feed-header-new-img">
                                    </span>
                                </a>
                    ...
                    <div class=title-like-wrap>
                        <button type="button" class="wish-button" aria-pressed="${nowKidsDTOS[i].isLiked}" nowKidsId="${nowKidsDTOS[i].nowKidsId}" eventId="${nowKidsDTOS[i].eventId}">
                            <svg viewBox="0 0 32 32" focusable="false" role="presentation" class="wish-button-svg" aria-hidden="true">
                                <path d="M22.16 4h-.007a8.142 8.142 0 0 0-6.145 2.79A8.198 8.198 0 0 0 9.76 3.998a7.36 7.36 0 0 0-7.359 7.446c0 5.116 4.64 9.276 11.6 15.596l2 1.76 2-1.76c6.96-6.32 11.6-10.48 11.6-15.6v-.08A7.36 7.36 0 0 0 22.241 4h-.085z"></path>
                            </svg>
                        </button>
