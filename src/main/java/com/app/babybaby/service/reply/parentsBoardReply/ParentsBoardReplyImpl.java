...
public class ParentsBoardReplyImpl implements ParentsBoardReply {
...
//    댓글 목록 불러오기
    ...
    public Slice<ParentsBoardReplyDTO> findAllReplyByBoardIdWithPaging(Pageable pageable, Long id) {
        Slice<com.app.babybaby.entity.reply.parentsBoardReply.ParentsBoardReply> parentsBoardReplySlice = parentsBoardReplyRepository.findAllReplyByBoardIdWithPaging(pageable, id);
